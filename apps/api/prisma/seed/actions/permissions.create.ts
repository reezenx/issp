...
> = {
  ...
  MANAGE_PROJECT_SUB_TYPE: {
    ...PERMISSION.MANAGE_PROJECT_SUB_TYPE,
    role: ROLE.SUPER_ADMIN,
  },
  CREATE_PROJECT_SUB_TYPE: {
    ...PERMISSION.CREATE_PROJECT_SUB_TYPE,
    role: ROLE.ADMIN,
  },
  READ_PROJECT_SUB_TYPE: {
    ...PERMISSION.READ_PROJECT_SUB_TYPE,
    role: ROLE.ADMIN,
  },
  UPDATE_PROJECT_SUB_TYPE: {
    ...PERMISSION.UPDATE_PROJECT_SUB_TYPE,
    role: ROLE.ADMIN,
  },
  DELETE_PROJECT_SUB_TYPE: {
    ...PERMISSION.DELETE_PROJECT_SUB_TYPE,
    role: ROLE.SUPER_ADMIN,
  },
