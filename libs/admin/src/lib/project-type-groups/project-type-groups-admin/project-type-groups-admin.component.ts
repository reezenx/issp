...
@Component({
  selector: 'issp-project-type-groups-admin',
  templateUrl: './project-type-groups-admin.component.html',
  styleUrl: './project-type-groups-admin.component.scss',
})
export class ProjectTypeGroupsAdminComponent implements OnInit {
  constructor(
  ...
  grid: GridComponent;
  gridId = 'itemsGrid';
  gridData: Array<ProjectTypeGroupDetails> =
