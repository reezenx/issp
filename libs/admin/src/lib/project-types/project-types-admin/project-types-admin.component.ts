...
@Component({
  selector: 'issp-project-types-admin',
  templateUrl: './project-types-admin.component.html',
  styleUrl: './project-types-admin.component.scss',
})
export class ProjectTypesAdminComponent implements OnInit {
  constructor(
  ...
  grid: GridComponent;
  gridId = 'itemsGrid';
  gridData: Array<ProjectTypeDetails> = new Array<ProjectTypeDetails>();
