...
export class IsspProjectsComponent implements AfterViewInit {
  ...
  openDialog(action: string, obj: any): void {
    obj.action = action;
    const dialogRef = this.dialog.open(ProjectDialogContentComponent, {
      data: obj,
    });
...
@Component({
  ...
  selector: 'issp-dialog-content',
  templateUrl: 'project-dialog-content.html',
})
...
export class ProjectDialogContentComponent {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ProjectDialogContentComponent>,
