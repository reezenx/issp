...
@Component({
  selector: 'issp-user-account-amendment',
  templateUrl: './user-account-amendment.component.html',
  styleUrl: './user-account-amendment.component.scss',
})
export class UserAccountAmendmentComponent implements OnInit {
  constructor(
