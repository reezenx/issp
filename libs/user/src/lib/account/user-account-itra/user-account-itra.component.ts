...
@Component({
  selector: 'issp-user-account-itra',
  templateUrl: './user-account-itra.component.html',
  styleUrl: './user-account-itra.component.scss',
})
export class UserAccountItraComponent implements OnInit {
  constructor(
