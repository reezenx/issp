...
@Component({
  selector: 'issp-user-account-monitoring',
  templateUrl: './user-account-monitoring.component.html',
  styleUrl: './user-account-monitoring.component.scss',
})
export class UserAccountMonitoringComponent implements OnInit {
  constructor(
